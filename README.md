...
| 2        | Alta           | Como coordenador, eu quero visualizar os projetos cadastrados por área de atuação para facilitar a organização. | 6 horas | Sprint 1 | Visualizar projetos por área de atuação | O sistema deve permitir a filtragem de projetos por área de atuação e exibir os resultados de forma intuitiva. |
| 3        | Alta           | Como coordenador, eu quero visualizar os projetos por responsáveis para saber quem está gerenciando cada um. | 5 horas | Sprint 1 | Visualizar projetos por responsáveis | O sistema deve permitir a filtragem de projetos por responsável e exibir os resultados de maneira clara e organizada. |
| 4        | Alta           | Como coordenador, eu quero atualizar os dados de um projeto para manter as informações sempre atualizadas. | 4 horas | Sprint 2 | Atualizar dados dos projetos | O sistema deve permitir a edição de projetos já cadastrados, com os dados atualizados refletindo na visualização. |
| 5        | Alta           | Como coordenador, eu quero excluir um projeto caso ele seja cancelado ou não seja mais necessário. | 3 horas | Sprint 2 | Excluir projetos da FAPG | O sistema deve permitir a exclusão de projetos, removendo-os permanentemente da plataforma. |
| 6        | Alta           | Como coordenador, eu quero visualizar os projetos por status para ver facilmente em que fase cada um se encontra. | 5 horas | Sprint 2 | Visualizar projetos pelo status | O sistema deve permitir a visualização de projetos filtrados por status, com informações sobre o andamento de cada um. |
| 7        | Alta           | Como coordenador, eu quero acompanhar o andamento das atividades de um projeto para garantir que estão sendo cumpridas. | 8 horas | Sprint 2 | Acompanhar andamento das atividades | O sistema deve exibir o progresso das atividades associadas a cada projeto, com atualizações em tempo real. |
| 8        | Média          | Como usuário, eu quero visualizar relatórios de andamento dos projetos para facilitar o acompanhamento de todos os envolvidos. | 10 horas | Sprint 3 | Outras visualizações/relatórios | O sistema deve permitir a geração de relatórios de status de projetos, com gráficos e dados relevantes para facilitar o acompanhamento. |
| 9        | Alta           | Como usuário, eu quero que a interface do sistema seja intuitiva e fácil de usar para que eu não precise de treinamentos complexos. | 12 horas | Sprint 3 | Usabilidade | O sistema deve ter uma interface limpa, amigável e fácil de navegar, sem necessidade de instruções detalhadas. |
