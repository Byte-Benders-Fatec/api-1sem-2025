...
| 7        | Alta           | Como um usuário, quero poder atualizar meus dados pessoais e minha foto de perfil, para manter minhas informações corretas e atualizadas no sistema. | 5 horas | Sprint 2 | Página de Perfil (alterar senha, mudar nome, e-mail, adicionar foto) | - Dado que estou na página de perfil, quando altero o nome e salvo, então o nome deve ser atualizado
- Dado que desejo alterar a senha, quando informo senha atual incorreta, então deve exibir erro
- Dado que quero adicionar uma foto, quando envio arquivo inválido, então deve impedir e alertar |  
