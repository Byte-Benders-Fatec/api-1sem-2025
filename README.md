...
| **Rank** | **Prioridade** | **User Story** | **Estimativa** | **Sprint** | **Requisito do Parceiro** | **Cenários de teste** |
|----------|----------------|----------------|----------------|------------|---------------------------|------------------------------------------|
