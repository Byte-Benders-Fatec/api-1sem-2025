...
| 2        | Alta           | Como coordenador, eu quero cadastrar, atualizar e excluir usuários no sistema | 9 horas | Sprint 1 | Cadastrar, editar e excluir usuários | O sistema deve permitir a criação, atualização e exclusão de usuários. |
...
| 6        | Alta           | Como usuário, eu quero que a interface do sistema seja intuitiva e fácil de usar para que eu não precise de treinamentos complexos. | 12 horas | Sprint 3 | Usabilidade | O sistema deve ter uma interface limpa, amigável e fácil de navegar, sem necessidade de instruções detalhadas. |
...
| 8        | Alta           | Como coordenador, eu quero acompanhar o andamento das atividades de um projeto para garantir que estão sendo cumpridas. | 8 horas | Sprint 2 | Acompanhar andamento das atividades | O sistema deve exibir o progresso das atividades associadas a cada projeto, com atualizações em tempo real. |
